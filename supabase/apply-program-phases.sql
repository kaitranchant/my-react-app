-- Creates program_phases table (migration 0026).
-- Run in Supabase Dashboard → SQL if the program builder shows:
--   "Could not find the table 'public.program_phases' in the schema cache"
--
