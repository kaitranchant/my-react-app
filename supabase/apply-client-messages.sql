-- Client messaging (migration 0027).
-- Run in Supabase Dashboard → SQL if the messages tab shows:
--   "Could not find the table 'public.client_messages' in the schema cache"
--
