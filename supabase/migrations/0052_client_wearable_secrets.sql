-- OAuth tokens for wearable connections (service-role only — no client/coach RLS policies)
...
-- Intentionally no RLS policies: only the Supabase service role may read/write tokens.
