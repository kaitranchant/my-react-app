-- Client progress photos: check-in-attached body photos in private storage
...
-- ---------------------------------------------------------------------------
-- Storage bucket: private progress photos
-- Path format: clients/{client_id}/{photo_id}.webp
-- ---------------------------------------------------------------------------
...
comment on table public.client_progress_photos is
  'Progress photos attached to check-ins or stored by date for coach review.';
