-- Fix client creation for coaches (manual gym patches could leave insert RLS broken).
-- Adds a security-definer RPC used by the app and recreates the insert policy.
