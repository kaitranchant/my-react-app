...
comment on table public.meal_plan_meal_foods is
  'Food line items that compose a meal plan meal, with scaled macro snapshots.';

-- ---------------------------------------------------------------------------
-- client_food_diary_entries catalog fields
-- ---------------------------------------------------------------------------
