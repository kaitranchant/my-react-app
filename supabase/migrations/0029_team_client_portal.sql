-- Client portal access to team data: read announcements/events, RSVP to events.
...
-- ---------------------------------------------------------------------------
-- Guard: clients may only change rsvp_status (not attendance_status)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- team_members — client SELECT own row
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- team_announcements — client SELECT
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- team_event_member_status — client SELECT / INSERT / UPDATE (RSVP only)
-- ---------------------------------------------------------------------------
